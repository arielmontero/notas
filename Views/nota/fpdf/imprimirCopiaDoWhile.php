...
do {
   ...
   $primersalto=strrpos($text[j], ".\r\n"); 
   $primerPunto=strrpos($text[j], ".");
...
$pdf->SetY($i=$i+10);
$pdf->SetX(25);
$pdf->Cell(0,7,"el valor de i " . $j ,0,0,'L',0);
$pdf->SetY($i=$i+10);
$pdf->SetX(25);
$pdf->Cell(0,7,"el primersalto " . $primersalto,0,0,'L',0);
$pdf->SetY($i=$i+10);
$pdf->SetX(25);
$pdf->Cell(0,7,"el primerPunto " . $primerPunto,0,0,'L',0);
$pdf->SetY($i=$i+10);
$pdf->SetX(25);
$pdf->Cell(0,7,"el desde " . $desde,0,0,'L',0);
$pdf->SetY($i=$i+10);
$pdf->SetX(25);
$pdf->Cell(0,7,"el hasta " . $hasta,0,0,'L',0);
